...
def upgrade():
    ...
    op.add_object('permission', **{'name': 'manage users'})
    op.add_object('permission', **{'name': 'manage permissions'})
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.delete_object('permission', **{'name': 'manage permissions'})
    op.delete_object('permission', **{'name': 'manage users'})
