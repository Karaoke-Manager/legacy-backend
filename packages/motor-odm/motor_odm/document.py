...
class Document(BaseModel, metaclass=DocumentMetaclass):
    ...
    __db__: Optional[AsyncIOMotorDatabase]
    __collection__: Optional[AsyncIOMotorCollection] = None

    id: ObjectId = Field(None, alias="_id")

    @classmethod
    def use(cls: Type['Document'], db: AsyncIOMotorDatabase):
    ...
    @classmethod
    def collection(cls: Type['Document']) -> AsyncIOMotorCollection:
        meta = cls.__mongo__
    ...
    @classmethod
    async def get(cls: 'GenericDocument', document_id: ObjectId) -> Optional['GenericDocument']:
